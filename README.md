...
If you are moving data from Supabase into Neon, use [`scripts/migrate-supabase-to-neon.sh`](scripts/migrate-supabase-to-neon.sh). It already restores into `DIRECT_URL`.

Nightly independent copies, Neon rewind, and restore: [docs/ops/backup-disaster-recovery.md](docs/ops/backup-disaster-recovery.md).
