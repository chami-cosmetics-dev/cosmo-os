                  ...
                  <ul className="divide-y rounded-md border">
                    {filterResults.map((row) => (
                      <li key={row.contactId}>
                        <button
                          type="button"
                          className={`flex w-full flex-col gap-3 px-3 py-3 text-left transition-colors sm:flex-row sm:items-center sm:justify-between sm:gap-4 ${selectedContactId === row.contactId
