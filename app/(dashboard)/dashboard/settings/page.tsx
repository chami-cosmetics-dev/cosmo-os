...
import { BookUser, Building2, Calculator, ChevronRight, FileArchive, Mail, MessageSquare, Package, Plug, Printer } from "lucide-react";

export const dynamic = "force-dynamic";

type SettingLink = {
  key: string;
  group: "Communication" | "Operations" | "Reports";
  title: string;
  description: string;
  href: string;
...
export default async function SettingsPage() {
    ...
    ...(canManageCompany
      ? [
          ...
          },
          {
            ...
            title: "Print Formats",
            description:
              "Create and manage custom HTML formats for order invoice printing.",
            href: "/dashboard/settings/print-formats",
            icon: Printer,
          },
          {
            key: "files",
            ...
            title: "Files",
            description:
              "Upload reusable files and icons for print formats and company assets.",
  ...
  const reportsLinks = settingLinks.filter((link) => link.group === "Reports");
  ...
  return (
    <div className="space-y-6">
      ...
      {canManageOutlets && <OutletsSettingsClient embedded />}
          ...
          {reportsLinks.length > 0 && (
            <Card className="overflow-hidden border-border/70 shadow-xs">
              <CardHeader className="border-b border-border/50 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--background)_92%,white),color-mix(in_srgb,var(--secondary)_12%,transparent))]">
                ...
                <CardDescription>Configuration for reporting and reconciliation tools.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-2">
