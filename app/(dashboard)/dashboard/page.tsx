...
const CallCenterPerformanceChart = nextDynamic(
  () =>
    import("@/components/organisms/call-center-performance-chart").then(
      (m) => m.CallCenterPerformanceChart
    ),
  { ssr: false }
);
