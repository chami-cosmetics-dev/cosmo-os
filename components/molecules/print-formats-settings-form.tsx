...
const VARIABLES = [
  ...
  "totals.productTotalFormatted, totals.shippingTotalFormatted, totals.grandTotalFormatted, totals.invoiceTotalFormatted, totals.prepaidLabel, totals.prepaidFormatted, totals.cashToCollectFormatted",
